...
import com.example.doan13.databinding.BottomSheetCustomForPlaylistBinding
...
class FavoriteSongFragment : Fragment() {
    ...
    private fun showBottomSheetOption (playlistId: String){
        ...
        bottomBinding.switchIsPublic.setOnClickListener {
            ...
            songViewModel.updatePublicStatusForPlaylist(playlistId = playlistId, isChecked)
            if(isChecked){
